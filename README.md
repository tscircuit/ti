...
GND and V_BAT use ordinary traces with `schDisplayLabel`, so their names render
inline on the wires instead of as standalone schematic net-label components.
