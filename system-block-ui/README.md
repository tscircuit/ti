...
The menu includes the Consumer wireless module, Bluetooth speaker, automotive,
and TIDA-010266 blood-pressure monitor examples; reset restores whichever
example was loaded most recently.
