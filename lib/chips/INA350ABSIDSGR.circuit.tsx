...
/** INA350ABS, gain 10/20, DSG0008A WSON. EP must connect to V_NEG. */
export const INA350ABSIDSGR = (props: ChipProps<typeof pinLabels>) => (
  <chip
    pinLabels={pinLabels}
    manufacturerPartNumber="INA350ABSIDSGR"
