...
export const SN74LVC1G04YZPR = (props: ChipProps<typeof pinLabels>) => {
  // Footprint provenance: TI drawing YZP0005; donor SN74LVC1G125YZPR (JLCPCB C2675663)
  return (
    <chip
      {...getTiSchematicLayout(pinLabels, { pinRoles })}
      pinLabels={pinLabels}
      pinAttributes={pinAttributes}
      manufacturerPartNumber="SN74LVC1G04YZPR"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
...
export default SN74LVC1G04YZPR;
