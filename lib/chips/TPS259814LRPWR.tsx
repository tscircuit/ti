...
export const TPS259814LRPWR = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="TPS259814LRPWR"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C5219030.obj?uuid=262834a5342148ebb2da8f3848ec58ce",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C5219030.step?uuid=262834a5342148ebb2da8f3848ec58ce",
        pcbRotationOffset: 0,
