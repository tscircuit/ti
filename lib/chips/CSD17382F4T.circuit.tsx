...
export const CSD17382F4T = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="CSD17382F4T"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin3"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C2859606.obj?uuid=2172206070d24ac0a7f8df923a642e0e",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C2859606.step?uuid=2172206070d24ac0a7f8df923a642e0e",
        pcbRotationOffset: 0,
        modelOriginPosition: {
