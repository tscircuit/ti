...
export const LM3880MF_1AC_NOPB = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="LM3880MF-1AC/NOPB"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C471861.obj?uuid=229b69761e2c45dba6a83d8866dec72d",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C471861.step?uuid=229b69761e2c45dba6a83d8866dec72d",
...
export default LM3880MF_1AC_NOPB;
