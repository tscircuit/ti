...
export const SN74AUP1G74DQER = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="SN74AUP1G74DQER"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin8"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C2677745.obj?uuid=94a7fb4c553546bf9f8faca4378a6a73",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C2677745.step?uuid=94a7fb4c553546bf9f8faca4378a6a73",
...
export default SN74AUP1G74DQER;
