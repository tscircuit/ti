...
export const TPS259461ARPWR = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="TPS259461ARPWR"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C3662780.obj?uuid=262834a5342148ebb2da8f3848ec58ce",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C3662780.step?uuid=262834a5342148ebb2da8f3848ec58ce",
        pcbRotationOffset: 0,
