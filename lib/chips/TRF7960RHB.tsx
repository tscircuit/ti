...
export const TRF7960RHB = (props: ChipProps) => (
  <chip
    ...
    pinLabels={{
      ...
      pin15: "VSS_A",
      pin16: "VDD_IO",
      pin17: ["PARALLEL_D0", "IO_0"],
      pin18: ["PARALLEL_D1", "IO_1"],
      pin19: ["PARALLEL_D2", "IO_2"],
      pin20: ["PARALLEL_D3", "IO_3"],
      pin21: ["SPI_CS", "PARALLEL_D4", "SLAVE_SELECT"],
      pin22: ["PARALLEL_D5", "IO_5"],
      pin23: ["SPI_MISO", "PARALLEL_D6", "MISO"],
      pin24: ["SPI_MOSI", "PARALLEL_D7", "MOSI"],
      pin25: "EN2",
      pin26: ["SPI_SCK", "PARALLEL_DATA_CLK", "DATA_CLK"],
      pin27: "SYS_CLK",
      pin28: "EN",
      pin29: "VSS_D",
      pin30: "OSC_OUT",
