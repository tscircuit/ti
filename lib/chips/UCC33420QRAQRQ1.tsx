...
export const UCC33420QRAQRQ1 = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="UCC33420QRAQRQ1"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C45082636.obj?uuid=b5bcbb964f3244d79f3a7508063243c0",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C45082636.step?uuid=b5bcbb964f3244d79f3a7508063243c0",
        pcbRotationOffset: 0,
        modelOriginPosition: {
...
export default UCC33420QRAQRQ1;
