...
export const SN74LVC2G34YZPR = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="SN74LVC2G34YZPR"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C544652.obj?uuid=1223783b9c9346aeb0b55e67e7a61f3e",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C544652.step?uuid=1223783b9c9346aeb0b55e67e7a61f3e",
        pcbRotationOffset: 0,
        modelOriginPosition: {
...
export default SN74LVC2G34YZPR;
