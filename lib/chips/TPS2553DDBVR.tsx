...
export const TPS2553DDBVR = (props: ChipProps<typeof pinLabels>) => {
  ...
  return (
    <chip
      ...
      manufacturerPartNumber="TPS2553DDBVR"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C521201.obj?uuid=229b69761e2c45dba6a83d8866dec72d",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C521201.step?uuid=229b69761e2c45dba6a83d8866dec72d",
