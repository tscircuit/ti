...
export const AM4378BZDND100 = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="AM4378BZDND100"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C2879669.obj?uuid=31ff4bad0f934917b11ca31c0ffdb105",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C2879669.step?uuid=31ff4bad0f934917b11ca31c0ffdb105",
        pcbRotationOffset: 0,
        modelOriginPosition: {
