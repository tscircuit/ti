...
export const CSD25481F4 = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="CSD25481F4"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin3"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C2872850.obj?uuid=2172206070d24ac0a7f8df923a642e0e",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C2872850.step?uuid=2172206070d24ac0a7f8df923a642e0e",
        pcbRotationOffset: 0,
        modelOriginPosition: {
