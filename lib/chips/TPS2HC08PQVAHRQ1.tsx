...
export const TPS2HC08PQVAHRQ1 = (props: ChipProps<typeof pinLabels>) => {
  // Footprint provenance: TI drawing VAH0011C; official source https://www.ti.com/lit/gpn/TPS2HC08-Q1 pages 74
  return (
    <chip
      {...getTiSchematicLayout(pinLabels, { pinRoles })}
      pinLabels={pinLabels}
      pinAttributes={pinAttributes}
      manufacturerPartNumber="TPS2HC08PQVAHRQ1"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
...
export default TPS2HC08PQVAHRQ1;
