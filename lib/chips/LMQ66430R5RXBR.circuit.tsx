...
export const LMQ66430R5RXBR = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="LMQ66430R5RXBR"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin2"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C22440565.obj?uuid=85f04e68b40e45bda806c782d7805dcb",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C22440565.step?uuid=85f04e68b40e45bda806c782d7805dcb",
        pcbRotationOffset: 0,
        modelOriginPosition: {
