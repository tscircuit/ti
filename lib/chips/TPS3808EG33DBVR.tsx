...
export const TPS3808EG33DBVR = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="TPS3808EG33DBVR"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C34900976.obj?uuid=3ad7d63f003b45d1b666dbfb37d8a25f",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C34900976.step?uuid=3ad7d63f003b45d1b666dbfb37d8a25f",
        pcbRotationOffset: 0,
        modelOriginPosition: { x: 0.000012700000070253736, y: 0, z: -0.8 },
      }}
      {...props}
    />
  );
...
export default TPS3808EG33DBVR;
