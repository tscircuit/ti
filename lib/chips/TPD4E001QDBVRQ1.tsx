...
export const TPD4E001QDBVRQ1 = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="TPD4E001QDBVRQ1"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C1973712.obj?uuid=229b69761e2c45dba6a83d8866dec72d",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C1973712.step?uuid=229b69761e2c45dba6a83d8866dec72d",
...
export default TPD4E001QDBVRQ1;
