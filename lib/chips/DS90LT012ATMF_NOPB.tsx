...
export const DS90LT012ATMF_NOPB = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="DS90LT012ATMF/NOPB"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C130171.obj?uuid=460193f9bf2d42e58cf3c2f675b07dc6",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C130171.step?uuid=460193f9bf2d42e58cf3c2f675b07dc6",
...
export default DS90LT012ATMF_NOPB;
