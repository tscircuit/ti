...
export const MSPM0L1305SDYYR = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="MSPM0L1305SDYYR"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C19189320.obj?uuid=c5c8e41d4e8d4e6a9b2f660c5795adfa",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C19189320.step?uuid=c5c8e41d4e8d4e6a9b2f660c5795adfa",
...
export default MSPM0L1305SDYYR;
