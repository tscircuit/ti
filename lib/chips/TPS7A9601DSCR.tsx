...
export const TPS7A9601DSCR = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="TPS7A9601DSCR"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C22015929.obj?uuid=156e205a83594893a980adc9e51e4d53",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C22015929.step?uuid=156e205a83594893a980adc9e51e4d53",
        pcbRotationOffset: 0,
        modelOriginPosition: {
