...
export const AM4376BZDND80 = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      manufacturerPartNumber="AM4376BZDND80"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin1"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C1522435.obj?uuid=31ff4bad0f934917b11ca31c0ffdb105",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C1522435.step?uuid=31ff4bad0f934917b11ca31c0ffdb105",
        pcbRotationOffset: 0,
        modelOriginPosition: {
