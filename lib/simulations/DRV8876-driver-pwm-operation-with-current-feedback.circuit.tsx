...
export const DRV8876DriverPwmOperationWithCurrentFeedbackCircuit = () => (
  <board routingDisabled>
    ...
    <voltageprobe
      name="IPROPI_PROBE"
      connectsTo="U1.IPROPI"
      referenceTo="U1.GND"
      color="#d946ef"
      graphDisplayName="VIPROPI"
      graphCenter={0.6}
      graphVerticalOffset={-1}
      graphVoltagePerDiv={1}
    />

    <analogsimulation
      name="DRV8876 Driver PWM Operation With Current Feedback"
      duration="2ms"
      startTime="1.8ms"
      timePerStep="100ns"
      spiceEngine="ngspice"
...
export default DRV8876DriverPwmOperationWithCurrentFeedbackCircuit;
