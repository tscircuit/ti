...
/**
 * C6 is drawn vertically in Altium while both wires leave toward U1. The
 * native capacitor obstacle cannot route that source geometry at this scale,
 * so use the same two-pin generic-symbol convention as other custom symbols
 * in this repository while retaining the real part metadata.
 */
 ...
 * Component centers, border, label anchors, and route bends use the normalized
 * source coordinates without re-layout.
 *
